...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='models/detect/yolov9-c-ourNeck-ELAN4.yaml', help='model.yaml path')
    # parser.add_argument('--cfg', type=str, default='models/detect/yolov9-c-goldyolo-ELAN4.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/DOTAv1.yaml', help='dataset.yaml path')
