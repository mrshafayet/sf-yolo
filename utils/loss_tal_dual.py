...
from utils.metrics import bbox_iou, inner_iou, focaler_iou, focaler_inner_iou
...
class BboxLoss(nn.Module):
    ...
    def forward(self, pred_dist, pred_bboxes, anchor_points, target_bboxes, target_scores, target_scores_sum, fg_mask):
        ...
        iou = focaler_inner_iou(pred_bboxes_pos, target_bboxes_pos, ratio=1.0, xywh=True, eps=1e-7, CIoU=True, feat_h=640, feat_w=640,
                                scale=0, d=0.0, u=0.95)
