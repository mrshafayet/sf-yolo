...
class LCNMModule(nn.Module):
    def __init__(self, inc) -> None:
        super().__init__()

        self.IFconv = Conv(inc[0], inc[1], k=1) if inc[0] != inc[1] else nn.Identity()

        self.se = LSKblock(inc[1] * 2)
...
class CBAM(nn.Module):
    def __init__(self, channel, reduction=16, kernel_size=7):
        ...
        self.sa = CBAM_SpatialAttention(kernel_size)
...
class RepNCSPELAN4iRMB2(RepNCSPELAN4):
    def __init__(self, c1, c2, c3, c4, c5=1):  # ch_in, ch_out, out number of c2, out number of c3, RepNCSP number
        super().__init__(c1, c2, c3, c4, c5)
        self.cv3 = nn.Sequential(RepNCSP(c4, c4, c5), iRMB(c4, c4))
        self.cv5 = iRMB(c2//2, c2)
